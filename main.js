        ...
        function getRandomContent() {
            ...
            var content = '';
            for (var i = 0; i < getRandomInt(5, 18); i++) {
        ...
        function getRandomWord() {
            var words = ['grape', 'pitch', 'judgement','toll','gain','brag','committee','tap','jam','information','break','discovery','mosquito','tempt','mountain','south','west','north','south','inside','salt','pepper','pest','establish','if'];
            var word = '';
